...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("bg-card text-card-foreground border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] gap-6 overflow-hidden py-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 group/card flex flex-col", className)}
      {...props}
    />
  )
}
